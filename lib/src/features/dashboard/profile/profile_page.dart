...
class ProfilePage extends GetView<ProfileController> {
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Obx(() => signOutButton(context)),
                  ),
                ],
              ),
            ],
  ...
  Widget signOutButton(BuildContext context) => IgnorePointer(
        ...
        child: SizedBox(
          ...
          child: SizedBox(
            ...
            width: double.infinity,
            child: ButtonIcon(
              buttonColor: controller.isLoading.value ? gray500 : red50,
              textColor: controller.isLoading.value ? gray600 : red600,
              textLabel: "Sign Out",
              onClick: () {
                controller.doLogout();
              },
